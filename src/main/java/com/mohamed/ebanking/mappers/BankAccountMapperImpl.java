package com.mohamed.ebanking.mappers;

import com.mohamed.ebanking.dtos.AccountOperationDTO;
...
public class BankAccountMapperImpl {
    ...
    public AccountOperationDTO fromAccountOperatoin(AccountOperation accountOperation) {
        AccountOperationDTO accountOperationDTO = new AccountOperationDTO();
        BeanUtils.copyProperties(accountOperation, accountOperationDTO);
        return accountOperationDTO;
    }

    public AccountOperation fromAccountOperatoinDTO(AccountOperationDTO accountOperationDTO) {
